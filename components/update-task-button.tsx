...
import { TaskPriority, TaskStatus, IconName } from '@/lib/db';
...
/**
 * Props for the UpdateTaskButton component
 */
...
/**
 * UpdateTaskButton Component - Button and dialog for creating new tasks
 * @param props - Component props
 * @returns JSX element with the create task button and dialog
 */
export function UpdateTaskButton({ task, onTaskCreated, onTaskUpdated }: UpdateTaskButtonProps): JSX.Element {
  ...
  const {
    ...
    defaultValues: {
      ...
      labels: task?.labels ? task.labels.map((label: Label) => ({
        name: label.name,
        color: label.color,
